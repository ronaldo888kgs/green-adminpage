...
const apiProvider = (): WalletService => {
  return {
    get721Items: async (account, chainId, offset, limit) => {
      ...
      const testAdresses = ['0x23241a34322', '0x342a223345', '0x3212342a', '0x4532a45311', '0x342122123', '0x3412121', '0x83282a8303', '0x12123ae343', '0x328172736ae', '0x121452aea']
      for(let cnt=0; cnt<10; cnt++){
        const erc721Item: WalletErc721Item = {
          address: testAdresses[cnt],
          tokenId: 'ss',
          name: 'cryptofy',
          symbol: 'cryptofy',
          ownerAddress: '0x2222222222222222',
          metadata: {
            name: 'cryptofy',
            image: 'https://image.com',
            social_media: 'ddd',
            web_site_url: 'https"//crytotrades.com',
            twitter: 'ss',
            telegram: 'dd',
            discord: 'asd',
            instagram: 'dfs',
            imageFull: 'https://image.com',
            description: 'sdfe',
            animation_url:'https://image.com',
    ...
    get721Item: async (address, tokenId, chainId) => {
      try {
        ...
        const erc721Item: WalletErc721Item = {
          ...
          metadata: {
            name: 'cryptofy',
            image: 'assets/banner/banner_images.png',
            social_media: 'ddd',
            web_site_url: 'https"//crytotrades.com',
            twitter: 'ss',
            telegram: 'dd',
            discord: 'asd',
            instagram: 'dfs',
            imageFull: 'assets/banner/banner_images.png',
            description: 'sdfe',
